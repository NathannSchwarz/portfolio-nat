<template>
  <footer class="bg-colored overflow-hidden">
    <div class="mx-5 pt-12  pb-1 text-colowhite">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 items-center mb-12 md:mb-16">
        <p class="font-lactos text-base text-coloyellow md:text-2xl lg:text-4xl ">
          "DESIGNING WITH FREEDOM MEANS CREATING SOLUTIONS THAT REFLECT AUTHENTICITY, EMBRACE INDIVIDUALITY, AND EMPOWER CHOICES FOR A LIMITLESS FUTURE."
        </p>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-y-10  mb-8 md:mb-0">
        <!-- Liens de navigation -->
        <div class="space-y-2">
        ...
        <div class="ml-16 space-y-2 md:ml-0">
          <h3 class="font-lactos text-xl text-coloyellow md:text-2xl lg:text-3xl">SOCIAL</h3>
          <ul class="font-unbounded text-sm text-black font-medium md:text-lg lg:text-xl">
            <li>
              <a href="https://www.instagram.com/nvt_vnn/?next=%2F" target="_blank" rel="noopener noreferrer" class="hover:text-colowhite transition-colors duration-500">INSTAGRAM</a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/nathan-schwarz04/" target="_blank" rel="noopener noreferrer" class="hover:text-colowhite transition-colors duration-500">LINKEDIN</a>
            </li>
            <li>
              <a href="https://x.com/NathScz" target="_blank" rel="noopener noreferrer" class="hover:text-colowhite transition-colors duration-500">X (TWITTER)</a>
            </li>
          </ul>
        </div>
        ...
        <div class="space-y-2">
          <h3 class="font-lactos text-xl text-coloyellow md:text-2xl lg:text-3xl">INFORMATION</h3>
          <ul class="font-unbounded text-sm text-black font-medium md:text-lg lg:text-xl">
      ...
      <p class="font-lactos text-[21vw] md:text-[22vw] lg:text-[22.5vw] text-coloyellow ">NVT_VNN</p>
      <p class="font-lactos text-[2.5vw] md:text-[2vw] text-coloyellow  -mt-6 md:-mt-16 lg:-mt-24 mb-8  ">© 2024 NATHAN SCHWARZ</p>
    </div>
  </footer>
</template>
