const projects = [
...

  {
    ...
    description2: `<p>From January to June, this project provided us with valuable experience in the <strong>research, testing, and validation phases</strong> of a web interface. We designed the entire project’s<strong> visual identity</strong>, including extensive <strong>logo research</strong>, involving multiple iterations to refine the branding.</p>`,
