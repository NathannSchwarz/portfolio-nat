    ...
    <div ref="horizontalScrollSection" class="w-screen h-auto lg:flex lg:w-[200vw] lg:h-screen">
      ...
      >
        ...
        <div class="text-center flex flex-col gap-4 md:gap-6 items-center">
          ...
          <p
            class="mx-8 md:mx-9 font-unbounded font-light text-xs mb-44 md:text-xl lg:text-lg xl:text-2xl md:w-4/5 lg:w-7/12 xl:w-6/12 md:m-auto lg:text-2xl text-center"
          >
