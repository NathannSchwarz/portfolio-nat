...
const filteredProjects = computed(() => {
  ...
  return projects.value.filter((project) => activeFilters.value.includes(project.category))
})
...
<template>
  <section class="relative bg-colowhite pb-32 overflow-hidden px-5 overflow-hidden">
    ...
    >
      ...
      creating meaningful, impactful designs.<br />Let’s collaborate
      <span class="font-medium">to bring your vision to life</span>.
    </p>
